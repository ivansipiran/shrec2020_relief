...
**
** Created: Fri Jul 13 01:45:45 2012
...
int QCustomPlot::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 13: titleClick((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        case 14: titleDoubleClick((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        case 15: selectionChangedByUser(); break;
        case 16: beforeReplot(); break;
        case 17: afterReplot(); break;
        case 18: deselectAll(); break;
        case 19: replot(); break;
        case 20: rescaleAxes(); break;
        default: ;
        }
        _id -= 21;
    }
