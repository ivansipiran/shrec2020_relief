...
MainWindow::MainWindow(char* dataFile, QWidget *parent) :
  QMainWindow(parent),
  ui(new Ui::MainWindow)
{
  ui->setupUi(this);
  ...
  setupPlot(ui->customPlot, dataFile);
}
...
void MainWindow :: keyPressEvent(QKeyEvent* event){
	if(event->key() == Qt::Key_P){
		ui->customPlot->savePdf(QString("temp.pdf"), true);
	}
}
	
void MainWindow::setupPlot(QCustomPlot *customPlot, char* dataFile){
  ...
  customPlot->xAxis->setLabel("Edge length");
