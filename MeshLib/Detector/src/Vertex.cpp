...
int Vertex :: getRadius(Vertex*  vertices, double radius, std::vector<Vertex*>& V){
...
void Vertex :: getPatch(Vertex* vertices, std::vector<int> indices, std::set<int>& returned, std::set<int>& faceR, double radius, Vertex center){
	std::set<int> waiting;
